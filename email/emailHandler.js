...
exports.QuotationEmailSentToAdminHandler = async (order) => {
...
exports.QuotationEmailSentToCustomerHandler = async (order) => {
...
exports.PaymentConfirmationEmailForQuotationSentToCustomerHandler = async (order) => {
